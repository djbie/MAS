...
choice /C:10 /N
if !errorlevel!==2 rem
if !errorlevel!==1 (start https://github.com & start %mas%/idm-activation-script & exit /b)
)
)
...
if %_erl%==6 exit /b
if %_erl%==5 start https://google.com & start https://massgrave.dev/idm-activation-script & goto MainMenu
